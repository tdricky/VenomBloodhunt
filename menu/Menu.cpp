// Released by Lord Wavey
// Discord: https://discord.gg/zySpU3KjsM
// Github: https://github.com/LordWavey
// YouTube: https://www.youtube.com/channel/UCXPkmrWAe3Bqvpv0sVliU_A

// Use this menu as you wish!
#include "Menu.hpp"
#include "../HUD.hpp"
#include "../RCS.hpp"
#include "../ESP.hpp"
...
void Menu::renderLogo() {
	ImGui::BeginGroup(); { // group it so we can redirect to Website when its pressed
		...
		ImGui::TextUnformatted(obf("Menu").c_str());
		ImGui::PopFont();

		ImGui::EndChild();

		if (ImGui::IsItemClicked(1)) { // redirect to a website/discord on right click
			::ShellExecuteA(NULL, obf("open").c_str(), obf("https://discord.gg/zySpU3KjsM").c_str(), NULL, NULL, SW_SHOWDEFAULT);
		}
